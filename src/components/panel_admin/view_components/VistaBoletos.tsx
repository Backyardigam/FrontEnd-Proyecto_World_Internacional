      ...
      <div className="p-4 border rounded-lg bg-gray-50 mb-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
          ...
          >
            ...
            {availableSchedules.map((h, index) => (
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="w-full px-4 py-2 bg-gray-300 text-gray-800 font-semibold rounded-md hover:bg-gray-400"
            >
              Limpiar
            </button>
          </div>
                  ...
                  <tr key={ticket.id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      <button
                        ...
                        className="text-white hover:bg-blue-800 font-semibold bg-blue-500 px-3 py-1 rounded-2xl"
                      >
                        Detalles
                      </button>
                    </td>
